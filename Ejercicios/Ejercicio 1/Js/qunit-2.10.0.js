...
(function (global$1) {
  ...
  var performanceNow = hasPerformanceApi
  ...
  Test.prototype = {
    ...
    before: function before() {
      ...
      var callbackPromises = notStartedModules.reduce(function (
        promiseChain,
        startModule
      ) {
        return promiseChain.then(function () {
      ...
      return runLoggingCallbacks("testDone", {
        ...
        .then(function () {
          if (module.testsRun === numberOfTests(module)) {
            ...
            return completedModules.reduce(function (
              promiseChain,
              completedModule
            ) {
              return promiseChain.then(function () {
    ...
    queue: function queue() {
      ...
      function runTest() {
        return [
          ...
          toConsumableArray(test.hooks("afterEach").reverse()),
      ...
      if ("hidepassed" === field.name && "replaceState" in window$1.history) {
        ...
        if (tests) {
          ...
          if (field.checked) {
            ...
            try {
              for (
                var _iterator = hiddenTests[Symbol.iterator](), _step;
    ...
    QUnit.testDone(function (details) {
      ...
      if (details.source) {
        ...
        sourceName.innerHTML =
          "<strong>Source: </strong>" + escapeText(details.source);
    ...
    window$1.onerror = function (
      ...
      if (originalWindowOnError) {
        ...
        ret = originalWindowOnError.call.apply(
          ...
          [this, message, fileName, lineNumber, columnNumber, errorObj].concat(
            args
          )
        );
      }
